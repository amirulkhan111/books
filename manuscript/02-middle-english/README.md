...
Status: 🟨 in progress (9 of 9 chapters drafted — full first-draft pass complete; pending peer/copy-edit review across all chapters)
...
- [x] 3. [Geoffrey Chaucer: life, *The Canterbury Tales*, *Troilus and Criseyde*](03-geoffrey-chaucer.md) — 🟨 drafted, sourced and cross-checked; pending peer/copy-edit pass
- [x] 4. [William Langland and *Piers Plowman*; alliterative revival](04-langland-piers-plowman-alliterative-revival.md) — 🟨 drafted, sourced and cross-checked; pending peer/copy-edit pass
...
- [x] 9. [The transition to print: Caxton and the close of the medieval period](09-transition-to-print-caxton.md) — 🟨 drafted, sourced and cross-checked; pending peer/copy-edit pass
